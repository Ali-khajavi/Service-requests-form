...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const form = document.querySelector('[data-srf-project-form]');
    if (!form) return;

    const step1 = form.querySelector('.srf-step-1');
    const step2 = form.querySelector('.srf-step-2');

    const next = form.querySelector('.srf-next');
    const back = form.querySelector('.srf-back');

    const title = form.querySelector('[name="srf_project_title"]');
