...
if ( ! class_exists( 'SR_Form_Handler' ) ) {
    ...
    class SR_Form_Handler {
        ...
        /**
         * Init hooks for the form handler.
         */
        ...
        public static function enqueue_assets() {
            // Detect correct asset paths (supports either /assets/... OR root files)
        ...
        public static function render_form_shortcode( $atts = array(), $content = '' ) {
            ...
            // Default selected service = first service
            ...
            // Handle POST submit (Phase 4)
            if ( ! empty( $_POST['srf_form_submitted'] ) ) {

                // Always capture "old values" for repopulation
                $old_data = array(
                ...
                // Keep selected service on errors
                if ( ! empty( $old_data['service'] ) ) {
                    $selected_service_id = (int) $old_data['service'];
                }

                // Permission check (server-side). JS popup is nice but not enough.
                ...
                // Required: name, email, description, terms
                ...
                // If no errors: create the CPT post
                if ( empty( $errors ) ) {
                    ...
                    $post_id = wp_insert_post(
                        array(
                            ...
                            'post_status'  => 'publish', // you can change later to 'private' or 'pending'
                            'post_title'   => $title,
            ...
            // Get full data for selected service (for the info area)
        ...
        /**
         * Load a template from the templates folder, with variables.
         *
